...
(function(){
  ...
  function buildMessages(ev){
    ...
    // прямая речь
    if(ev.dialogue){
      var NMAP={'сдвиг':'shift','рекрут':'recruit','миллер':'miller','эленор':'eleanor','куратор':'kurator','патрульный':'cop','парень':'miller','старуха':'eleanor','капитан':'captain','хейс':'hayes','дэнни':'danny'};
