...
(function(){
  ...
  const FACES=[
    ...
    {id:'blocks',  name:'Архив',      ico:'🗄', sub:'Уложи папки в линии', available:true,  c1:'#6c8fc0',c2:'#28384f'},
    {id:'merge2048', name:'Дедукция', ico:'🧠', sub:'Сливай факты в вывод', available:true,  c1:'#c86464',c2:'#5e2626'},
    {id:'bubbles', name:'Доска связей',ico:'🎯', sub:'Лопай грозди зацепок',available:true,  c1:'#5ab0a0',c2:'#1d4a43'},
