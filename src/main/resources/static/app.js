...
const MAP_NODES=[[0.4981,0.955],[0.499,0.9159],[0.4769,0.8767],[0.5049,0.8376],[0.4905,0.7985],[0.4955,0.7593],[0.4953,0.7202],[0.4752,0.6811],[0.5017,0.642],[0.5088,0.6028],[0.5391,0.5637],[0.4569,0.5246],[0.5775,0.4854],[0.5461,0.4463],[0.5179,0.4072],[0.4996,0.368],[0.5016,0.3289],[0.5025,0.2898],[0.505,0.2507],[0.4964,0.2115],[0.4989,0.1724],[0.4366,0.1333],[0.4882,0.0941],[0.492,0.055]];
...
function renderMap(){
  ...
  // ── таблички глав по районам (снизу вверх: музей, старый город, доки, лес, особняк) ──
  const PLAQUES=[
    {name:'Музейный квартал', y:0.965},
    {name:'Старый город',     y:0.775},
    {name:'Ночные доки',      y:0.585},
    {name:'Туманный лес',     y:0.40},
    {name:'Особняк',          y:0.085},
  ];
  PLAQUES.forEach((p)=>{
