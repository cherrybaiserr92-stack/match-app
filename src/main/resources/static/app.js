...
const MAP_NODES=[[0.4952,0.9558],[0.5346,0.914],[0.5314,0.8746],[0.4997,0.8393],[0.4832,0.8033],[0.5291,0.7744],[0.4861,0.7207],[0.4857,0.6799],[0.4876,0.6387],[0.5108,0.6008],[0.5036,0.5676],[0.512,0.5296],[0.5019,0.4779],[0.4938,0.4371],[0.4835,0.3999],[0.5001,0.36],[0.5209,0.3243],[0.4899,0.2855],[0.5098,0.2209],[0.5074,0.1913],[0.504,0.1607],[0.5045,0.1296],[0.499,0.1002],[0.5016,0.0685]];
...
function renderMap(){
  ...
  // ── таблички глав на стыках (прячут шов + обозначают район) ──
  // порядок по запросу: музейный квартал в самый низ, выше — старый город, доки, особняк
  const PLAQUES=[
